...
describe("A babysitter", function() {
    ...
    describe("who watches children for two hours, long before late bedtime", function () {
        var result = babysitter.calculatePay(5, 7, 12);
        it("costs $20", function(){
            expect(result).toBe(20);
        });
    });
    ...
    describe("who arrives two hours after 7pm bedtime and stays until 2am", function(){
        var result = babysitter.calculatePay(9, 2, 7);
        it("costs $34", function(){
    ...
    describe("who leaves immediately due to an unforeseen emergency", function(){
        var result = babysitter.calculatePay(7, 7, 8);
        it("costs $0", function(){

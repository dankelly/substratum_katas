function Babysitter(arrival, departure, bedtime){
    ...
    this.calculatePay = function(){
        ...
        var basePay = billableHours * this.WATCHING_KIDS_RATE;
        ...
        var kidsInBedAdjustment = (this.WATCHING_KIDS_RATE - this.KIDS_IN_BED_RATE) * billableHoursAfterBedtime;
        ...
        return basePay - kidsInBedAdjustment - afterMidnightAdjustment;
